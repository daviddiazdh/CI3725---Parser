...
program = (lambda x1:(lambda x1: tail(tail(((lambda x1: tail(tail(((lambda x1 : x1))((apply(lambda x7:lambda x6:lambda x5:lambda x4:lambda x3:lambda x2:lambda x1: cons(x7)(cons(x6)(cons(x5)(cons(x4)(cons(x3)(cons(2)(cons(x1)(nil)))))))))((lambda x1: tail((apply(lambda x8:lambda x7:lambda x6:lambda x5:lambda x4:lambda x3:lambda x2:lambda x1: cons(0)(cons(x7)(cons(x6)(cons(x5)(cons(x4)(cons(x3)(cons(x2)(cons(x1)(nil))))))))))((cons(0)(x1)))))((cons(0)(cons(0)(x1))))))))))(((lambda x1: (apply(lambda x5:lambda x4:lambda x3:lambda x2:lambda x1: cons(x5)(cons(x4)(cons(x3)(cons(x2)(cons(1+x1)(nil)))))))(x1) if (apply (lambda x5:lambda x4:lambda x3:lambda x2:lambda x1: x1 == x3[1]))(x1) else (x1)))((apply(lambda x5:lambda x4:lambda x3:lambda x2:lambda x1: cons(x5)(cons(x4)(cons([1,0,3])(cons(x2)(cons(x1)(nil)))))))((cons(0)(cons(0)(x1)))))))))(x1))
